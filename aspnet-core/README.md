...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p bdc753a5-7ed3-4945-a3d5-026b802b72f6
```

> `bdc753a5-7ed3-4945-a3d5-026b802b72f6` is the password of the certificate, you can change it to any password you want.
